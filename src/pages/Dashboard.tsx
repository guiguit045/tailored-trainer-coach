...
import { Dumbbell, Apple, Settings, LogOut, BarChart3, User, Target, TrendingUp, Library } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto py-8 px-4">
        ...
        <Tabs defaultValue={defaultTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 h-auto p-1">
            ...
            <TabsTrigger value="exercises" className="py-3 data-[state=active]:bg-gradient-hero data-[state=active]:text-primary-foreground">
